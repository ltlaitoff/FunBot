...
API_KEY = 'RGAPI-c5f706c3-840d-4277-a0d9-39cfec4e88c2'
LOCALE = 'europe'
...
def update_users_last_matches():
  ...
  for item in users:
    puuid = item[1]
    response = requests.get(f'https://{LOCALE}.api.riotgames.com/lol/match/v5/matches/by-puuid/{puuid}/ids?start=0&count=40&api_key={API_KEY}').json()
